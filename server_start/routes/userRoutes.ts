...
import userController from '../controllers/userController'; // we import the userController from the userController file
...
export default router; // we export the router so we can use it in the index.js file