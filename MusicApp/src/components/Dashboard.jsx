...
const Dashboard = () => {
    ...
    const handlePlayMusic = async (song) => {
        ...
        const id_device = "2b13d92381e6650a06db474a218bac71bccb0bf5";
    ...
    const getToken = async () =>{
        ...
        const clientId = '597955b0116e489b89341d011b9ad146';
    ...
    return(
        <div className={'flex bg-gradient-to-b from-spotify-grey from-90% to-[#1DB954] h-screen justify-center align-items-center over w-full'}>
            <div className='overflow-y-scroll'>
                <div className={'pt-5 flex justify-center '}>
                    <h1 className={'text-2xl font-bold text-spotify-green'}>Corridos Tumbados player</h1>
                </div>
